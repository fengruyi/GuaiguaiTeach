package com.guaiwa.guaiguaiteach.widget.viewpager;
...
/**
 * Created by 80151689 on 2017-07-20.
 */
...
public class CustomViewpager extends ViewGroup {
    ...
    private int validYSliding = (int) (PhoneInfo.screenHeight * 0.15);
    private boolean isYSlideOutEnable;//是否支持Y方向滑动退出，滑动有效距离validYSliding
    ...
    public void setYSlideOutEnable(boolean YSlideOutEnable) {
        isYSlideOutEnable = YSlideOutEnable;
    }
...
//            this.setChildrenDrawingOrderEnabled(hasTransformer);
    ...
    public void setOnTouchSlopListener(CustomViewpager.OnTouchSlopListener onTouchSlopListener) {
...
//                        }
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            if (activePointerId != -1) {
                                ...
                                if (xDiff > (float) this.mTouchSlop && xDiff * 0.5F > yDiff && !mIsUnableToDrag) {
                                    ...
                                    this.mLastMotionY = y;
                                    this.setScrollingCacheEnabled(true);
                                } else if (yDiff > (float) this.mTouchSlop && yDiff * 0.5F > xDiff && mScroller.isFinished()) {
                                    this.mIsUnableToDrag = true;
                                }
        ...
        if (this.mDisableTouch) {
            ...
            switch (action & MotionEvent.ACTION_MASK) {
                    ...
                    if (mOnTouchSlopListener != null) {
                        ...
                        if (view != null && view.getTranslationY() != 0) {
                            if (Math.abs(view.getTranslationY()) < validYSliding) {
                                ...
                                AnimatorSet set = new AnimatorSet();
                                set.playTogether(
                                        ObjectAnimator.ofFloat(view, "translationY", view.getTranslationY(), view.getTranslationY() > 0 ? PhoneInfo.screenHeight : -PhoneInfo.screenHeight)
                                );
                                set.setDuration(300)
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (this.mIsBeingDragged && translationY == 0) {
                        index = ev.findPointerIndex(this.mActivePointerId);
                        x = ev.getX(index);
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        ClassLoader loader;
        public static final ClassLoaderCreator<SavedState> CREATOR = new ClassLoaderCreator() {
